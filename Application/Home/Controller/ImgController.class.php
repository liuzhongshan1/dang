...
class ImgController extends Controller {
    public function index(){
	  ...
	  $count = $Post -> where('dang_post.type=2') -> count();
	  ...
	  $list = $Post->query(" select *  from dang_post,dang_user where dang_post.uid = dang_user.id and dang_post.type=2 order by time desc limit {$Page->firstRow},{$Page->listRows}") ;
