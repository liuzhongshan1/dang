  ...
  <body>
		...
		<div id="content" class="container" style="margin-top:60px;">
			<div class="row">
				<div class="col-md-7">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default" style="margin-top:15px;-moz-box-shadow:5px 5px 8px #333333; -webkit-box-shadow:5px 5px 8px #333333; box-shadow:5px 5px 8px #333333;">
												<div class="panel-heading" style="background:white;">
													<a href="/5dangpai.com/index.php/Home/Discuz/index/uid/<?php echo ($vo["uid"]); ?>">
														<img src="/5dangpai.com/Public/user/head/<?php echo ($vo["headShow"]); ?>"  class="img-circle" height="30">
													</a>
												</div>
											
												<div class="panel-body" style="text-indent:2em;">
																								
													<a href="/5dangpai.com/index.php/Home/Discuz/index/id/<?php echo ($vo["pid"]); ?>" style="font-size: 16px;line-height: 1.8;word-wrap: break-word;color: #333;margin-bottom: 10px;text-decoration: none;">
														<p><?php echo ($vo["text"]); ?>
														</p>
													</a>
													<a href="/5dangpai.com/index.php/Home/Discuz/index/id/<?php echo ($vo["pid"]); ?>">
														<img src="/5dangpai.com/Public/postImg/<?php echo ($vo["img"]); ?>" class="img-responsive img-thumbnail" style="margin: 0 auto;" >
													</a>
												</div>
				...
				<div class="col-md-1">
					<a href="/5dangpai.com/index.php/Home/Send/index"><img src="/5dangpai.com/Public/reception/img/post.png" class="img-responsive img-thumbnail" height="40" width="40" style="position:fixed;  bottom:150px;"></a>
				</div>
