  ...
  <body>
		...
		<div class="container" style="margin-top:60px;">
			...
			<div class="row">
				...
				<div class="col-lg-7">
					...
					<ul class="nav nav-tabs">
					  <li class="active">
						  <a href="#word" data-toggle="tab">
							<img src="/Public/reception/img/word.png"  class="img-rounded img-responsive" width="30" height="40">
						  </a>
					  </li>
					  
					  <li><a href="#img" data-toggle="tab">
							<img src="/Public/reception/img/img.png"  class="img-rounded img-responsive" width="30" height="40">
					  </a></li>
					  <li><a href="#video" data-toggle="tab">
							<img src="/Public/reception/img/video.png"  class="img-rounded img-responsive" width="30" height="40">
					  </a></li>
					...
					<div class="tab-content">
						  <div class="tab-pane active fade in " id="word">
								<form role="form" style="margin-top:20px;" action="/index.php/Home/Send/word" method="post">
					  ...
					  <div class="tab-pane fade" id="img">
								<form role="form" enctype="multipart/form-data" style="margin-top:20px;"  action="/index.php/Home/Send/img" method="post">
				...
				<div class="col-lg-3">
					<img class="img-responsive" src="/Public/reception/img/erwei.png" height="100">
					<img class="img-responsive" src="/Public/reception/img/rule.png" height="100">
